...
import com.service.actions.ContextProvider;
...
public class PdfTest {
        ...
        try {
            ...
            HtmlConverter.convertToPdf(pdfForma(idInvoice,username,total), outputStream, converterProperties);
    ...
    public static  String pdfForma(int idInvoice,String username,float total){
        ...
        contentHTML+=" "+"<body style=\"background-color: #f5f5f5; padding: 0; text-align: center; background: rgb(236, 236, 236);\" bgcolor=\"rgb(236,\">\n" +
                ...
                "            <img class=\"web-img\" border=\"0\" src=\"http://shop4makers.com/wp-content/uploads/2017/01/cropped-logo_sm_2.png\" width=\"172\" height=\"auto\" style=\"border: none; display: inline-block; font-size: 14px; font-weight: bold; height: auto; outline: none; text-decoration: none; text-transform: capitalize; vertical-align: middle; margin-right: 10px; max-width: 100%;\">\n" +
                "          </a>\n" +
                "        </td>\n" +
                "      </tr>\n" +
                "      </tbody>\n" +
                ...
                "          <div class=\"element-text-content\" style=\"min-height: 10px;\">\n" +
                "            <p style=\"margin: 0px;\">Hello! <span style=\"font-size: 14px;\"><c:out value=\""+ username
                +"\" />,</span></p>\n" +
                ...
                for (Object[] result : results) {
                    ...
                    contentHTML+=" <tr class=\"order_item\" style=\"border-color: inherit;\">\n" +
                            ...
                            "                        <span class=\"yaymail-product-name\"><c:out value=\""+articlesStock.getNomArt()+"\"/></span>\n" +
                            "                      </div>\n" +
                            "                    </th>\n" +
                            ...
                            "                      <c:out value=\""+commandes.getQteCmd()+"\"/>\t</th>\n" +
                            ...
                            "                    <span class=\"woocommerce-Price-amount amount\"><c:out value=\""+commandes.getQteCmd()*articlesStock.getPrixArt()+"\"/>\n" +
